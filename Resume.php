...
<h2> Projects
    <h4 class="projects">
        ...
        <p class="description"> I interviewed eight Washington University undergraduate students in hopes to get a better understanding
            ...
            The mental health resources that I specifically asked about were SHS counseling, Let’s Talk, StressBusters,
            Peer Health Educators, and Student Health 101. Overall I have found that while students are familiar with most of the
            resources that Washington University’s Health and Wellness team have to offer, they do not consider these programs
            mental health resources. Most students consider SHS counseling and Uncle Joe’s to be the only mental health resources
    ...
    <h4 class="projects">
        ...
        <p class="description">
            I spent the summer leraning how to code and created this blog
        </p>
    <h4 class="projects">
        Happy and Neutral Mood Induction on Math and Recall Tests (2016):
</h4>
        <p class="description"> Does one’s temporary mood affect the way a person will perform on different types of tasks?
            ...
            solving and memory recall. Sixteen Washington University students participated in the study all ranging in age
             ...
             either a happy or neutral mood and then required to complete either a memory recall or math task. A Latin-square
              ...
              recall task.  No main effect of mood, p = .37, was seen. An induced happy or neutral mood did not appear to
               ...
               findings show that mood does not affect one’s performance on different task types.
<div class = "aboutMe">
    <p>
...
<div class="resume">
    ...
    <li class="resume">
        <a class="resume" href = Resume.pdf>
            Click here to view my resume </a> </li></ul> </div>
<br/>
</div>
<br/>
    <h3>
